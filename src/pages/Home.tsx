        ...
        <>
            <div className="bg-[#111111] lg:hidden pt-32 h-screen w-full px-8">
                ...
                <CTABtn
                    ...
                    className="mt-[96px] min-[577px]:mx-auto min-[577px]:mt-7"
                >
                    MORE ABOUT ME
                </CTABtn>
            </div>
            ...
            <div className="hidden lg:block h-screen overflow-hidden relative bg-[#111111]">
                ...
                <div className="flex gap-10 items-center z-10 absolute left-[7.5vh] top-1/2 -translate-y-1/2">
                    <div className="w-[60vh] h-[85vh] bg-blue-200 overflow-hidden rounded-xl 2xl:rounded-3xl">
                        <img
                            src={fotoku}
                            alt=""
                            className="-rotate-90 scale-[2.2] translate-x-6"
                        />
                    </div>
                    ...
                    <div className="text-white 2xl:ml-[10vh]">
                        ...
                        <div className="font-osans mt-10 tracking-[1px] w-[400px] xl:w-[600px]">
                            Aspiring fullstack developer with a passion for
                            innovation. Explore my portfolio for a glimpse into
