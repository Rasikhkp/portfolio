...
export default function Carousel({
    ...
    return (
        <>
            <div className="fixed top-0 z-30 items-center hidden w-full h-screen overflow-hidden lg:flex">
                <button
                    onClick={handleNext}
                ...
                >
                    <img
                        src={chevLeft}
                        className="w-6 transition-all hover:opacity-60 active:opacity-40"
                        alt=""
                    />
                </button>
